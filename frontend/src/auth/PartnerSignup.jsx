...
import { signup, signupAsPartner } from "../state/authSlice.js";
export const PartnerSignup = () => {
  ...
  const submitForm = async (e) => {
    e.preventDefault();
    await dispatch(signupAsPartner({ email, password, confirmPassword }));
  };
  useEffect(() => {
    ...
    <>
      <main className="signup">
        <div className="auth-content">
          <h2>Sign up as partner in Passdn kitchen</h2>
          {/* {errors.signupError && (
          ...
          <div className="auth-form signup-form">
            <form onSubmit={submitForm}>
              ...
              <p className="already-acc">
                Are you customer? <Link to="/signup">Sign up here</Link>
              </p>
            </form>
            {errorInSignup && (
              <p
